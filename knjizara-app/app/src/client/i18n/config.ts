...
const srLatn = {
  ...
  "books": {
    ...
    "sellerType": "Tip prodavca",
    "allSellers": "Svi prodavci",
    "sellerPrivate": "Privatno lice",
    "sellerBusiness": "Firma",
    "priceRange": "Cena (RSD)",
    "priceFrom": "Od",
    "priceTo": "Do",
  ...
  "listing": {
    ...
    "allFieldsOptional": "Sva polja su opciona",
    "preview": "Pregled oglasa",
    "summary": "Rezime",
    "canGoBack": "Možete se vratiti nazad da izmenite podatke",
    "back": "Nazad",
    "next": "Dalje",
    "publish": "Objavi knjigu",
    "status": "Status",
    ...
    "errorCreate": "Greška pri kreiranju oglasa",
...
const srCyrl = {
  ...
  "books": {
    ...
    "allSellers": "Сви продавци",
    "sellerPrivate": "Приватно лице",
    "sellerBusiness": "Фирма",
    "priceRange": "Цена (РСД)",
    "priceFrom": "Од",
    "priceTo": "До",
  ...
  "listing": {
    ...
    "coverImagePlaceholder": "https://example.com/cover.jpg",
    "allFieldsOptional": "Сва поља су опциона",
    "preview": "Преглед огласа",
    "summary": "Резиме",
    "canGoBack": "Можете се вратити назад да измените податке",
    "back": "Назад",
    "next": "Даље",
    "publish": "Објави књигу",
    "status": "Статус",
    ...
    "errorCreate": "Грешка при креирању огласа",
