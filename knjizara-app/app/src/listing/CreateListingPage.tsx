      ...
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-card rounded-lg p-6 shadow-sm space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-foreground">{t('listing.requiredFields')} *</h3>
          ...
          <div className="space-y-4 pt-4 border-t border-border">
            <h3 className="text-lg font-semibold text-foreground">{t('listing.optionalFields')}</h3>
          ...
          <div className="flex gap-4 pt-4">
            ...
            <Button
              ...
              className="flex-1"
            >
              {isLoading ? t('common.loading') : t('listing.create')}
            </Button>
          </div>
        </form>
      </div>
